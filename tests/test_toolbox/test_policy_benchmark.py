...
class TestPolicyBenchmarkSchemas:
    ...
    def test_policy_ground_truth_pass_rate(self):
        ...
        policy_gt = PolicyGroundTruth(
            ...
            controls=[
                ControlGroundTruth(
                    control_id="A", title="A", expected_applicable=True, expected_pass=True
                ),
                ControlGroundTruth(
                    control_id="B", title="B", expected_applicable=True, expected_pass=False
                ),
                ControlGroundTruth(
                    control_id="C", title="C", expected_applicable=False, expected_pass=True
                ),
            ],
            annotated_at=date(2026, 2, 7),
        )
...
class TestPolicyEvaluation:
    ...
    def test_evaluate_ccd_not_applicable(self, sample_aibom_no_guardrails):
        ...
        ccd = {
            ...
            "assertions": [{"id": "test", "type": "must_exist", "query": {"type": "GUARDRAIL"}}],
            "scoring": {},
        }
...
class TestNuguardPolicies:
    ...
    def test_nuguard_policy_owasp_structure(self):
        ...
        owasp_policies = [p for p in list_nuguard_policies() if "owasp" in p.stem.lower()]
    ...
    def test_nuguard_policy_nist_structure(self):
        ...
        nist_policies = [p for p in list_nuguard_policies() if "nist" in p.stem.lower()]
    ...
    def test_nuguard_policy_soc2_structure(self):
        ...
        soc2_policies = [p for p in list_nuguard_policies() if "soc2" in p.stem.lower()]
