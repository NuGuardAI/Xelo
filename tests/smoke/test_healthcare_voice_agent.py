...
def doc() -> AiBomDocument:
    ...
    url = _build_repo_url()
    return SbomExtractor().extract_from_repo(url, _REPO_REF, _CONFIG)


def _names(doc: AiBomDocument, ctype: ComponentType) -> set[str]:
    return {n.name.lower() for n in doc.nodes if n.component_type == ctype}


def _adapters(doc: AiBomDocument) -> set[str]:
...
class TestFrameworkDetection:
    ...
    @skip_if_offline
    def test_detects_llm_clients_ts_framework(self, doc: AiBomDocument) -> None:
...
class TestAgentDetection:
    ...
    @skip_if_offline
    def test_detects_normalize_agent(self, doc: AiBomDocument) -> None:
    ...
    @skip_if_offline
    def test_detects_prognosis_agent(self, doc: AiBomDocument) -> None:
        agent_names = _names(doc, ComponentType.AGENT)
    ...
    @skip_if_offline
    def test_detects_specialist_lookup_agent(self, doc: AiBomDocument) -> None:
        agent_names = _names(doc, ComponentType.AGENT)
    ...
    @skip_if_offline
    def test_detects_recommend_specialists_agent(self, doc: AiBomDocument) -> None:
        agent_names = _names(doc, ComponentType.AGENT)
    ...
    @skip_if_offline
    def test_detects_fetch_doctor_details_agent(self, doc: AiBomDocument) -> None:
        agent_names = _names(doc, ComponentType.AGENT)
    ...
    @skip_if_offline
    def test_agent_count(self, doc: AiBomDocument) -> None:
        agent_names = _names(doc, ComponentType.AGENT)
...
class TestModelDetection:
    ...
    @skip_if_offline
    def test_detects_gpt4_model(self, doc: AiBomDocument) -> None:
    ...
    @skip_if_offline
    def test_detects_gemini_model(self, doc: AiBomDocument) -> None:
        model_names = _names(doc, ComponentType.MODEL)
    ...
    @skip_if_offline
    def test_gemini_model_has_google_provider(self, doc: AiBomDocument) -> None:
...
class TestPromptDetection:
    ...
    @skip_if_offline
    def test_detects_prompts(self, doc: AiBomDocument) -> None:
...
class TestRelationships:
    ...
    @skip_if_offline
    def test_agent_uses_model_edges_exist(self, doc: AiBomDocument) -> None:
    ...
    @skip_if_offline
    def test_all_edge_nodes_exist(self, doc: AiBomDocument) -> None:
...
class TestDocumentQuality:
    ...
    @skip_if_offline
    def test_has_nodes(self, doc: AiBomDocument) -> None:
        assert doc.nodes, "Extraction produced no nodes"

    @skip_if_offline
    def test_all_nodes_have_positive_confidence(self, doc: AiBomDocument) -> None:
    ...
    def test_deterministic_extraction(self) -> None:
        ...
        url = _build_repo_url()
        cfg = _CONFIG
        doc1 = SbomExtractor().extract_from_repo(url, _REPO_REF, cfg)
        doc2 = SbomExtractor().extract_from_repo(url, _REPO_REF, cfg)
