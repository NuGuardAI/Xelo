...
class SemanticKernelAdapter(FrameworkAdapter):
    ...
    priority = 40
    handles_imports = ["semantic_kernel", "semantic_kernel.kernel",
                        "semantic_kernel.connectors", "semantic_kernel.functions",
    ...
    def extract(
        ...
        for call in parse_result.function_calls:
            if call.function_name in {"add_plugin", "import_plugin_from_object",
                ...
                detected.append(ComponentDetection(
                    ...
                    priority=self.priority,
                    confidence=0.85,
                    metadata={"registration": call.function_name, "framework": "semantic_kernel"},
                    file_path=file_path,
                    line=call.line,
