...
2. An **AI-BOM** (from ``SbomExtractor``) containing agents, models, prompts,
...
class AiBomMerger:
    ...
    def merge(
        ...
        ai_doc:
            Extracted AI-BOM from ``SbomExtractor``.
        generator_method:
    ...
    def _count_by_type(self, doc: AiBomDocument) -> dict[str, int]:
        counts: dict[str, int] = {}
